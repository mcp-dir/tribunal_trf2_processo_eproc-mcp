...
Tribunal TRF2: Processo (eproc) segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [tribunal_trf2_processo_eproc@mcp.ai](mailto:tribunal_trf2_processo_eproc@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
